...
require_once $_SERVER['DOCUMENT_ROOT'].'/itel/dao/condutorDAO.php';
require_once $_SERVER['DOCUMENT_ROOT'].'/itel/model/condutor.php';

class CondutorController {

    private $condutorDao;
	public $lista_condutores;
...
$CondutorController = new CondutorController();
